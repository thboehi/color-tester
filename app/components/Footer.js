...
export default function Footer() {
    return (
        <footer className=" w-full flex flex-col items-center justify-center py-4 bg-gradient-to-t from-black/20 via-transparent to-transparent backdrop-blur-sm z-40">
